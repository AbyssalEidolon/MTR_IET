...
{
    /// <summary>
    /// Demonstration class using Audio.WindowsMicrophoneStream (from com.microsoft.mixedreality.toolkit.micstream) to select the 
    ...
    public class MicrophoneAmplitudeDemo : MonoBehaviour
    {
        ...
        private SpatialAwareness.IMixedRealitySpatialAwarenessMeshObserver spatialMeshObserver = null;
        ...
        /// </summary>
        private Audio.WindowsMicrophoneStream micStream = null;
        ...
        private void Awake()
        {
            ...
            spatialMeshObserver = (CoreServices.SpatialAwarenessSystem as IMixedRealityDataProviderAccess)?.GetDataProvider<SpatialAwareness.IMixedRealitySpatialAwarenessMeshObserver>();
            ...
            micStream = new Audio.WindowsMicrophoneStream();
            if (micStream == null)
            {
            ...
            Audio.WindowsMicrophoneStreamErrorCode result = micStream.Initialize(Audio.WindowsMicrophoneStreamType.HighQualityVoice);
            if (result != Audio.WindowsMicrophoneStreamErrorCode.Success)
            {
        ...
        private void OnDestroy()
        {
            ...
            Audio.WindowsMicrophoneStreamErrorCode result = micStream.StopStream();
            if (result != Audio.WindowsMicrophoneStreamErrorCode.Success)
            {
        ...
        private void OnDisable()
        {
            ...
            Audio.WindowsMicrophoneStreamErrorCode result = micStream.Pause();
            if (result != Audio.WindowsMicrophoneStreamErrorCode.Success)
            {
        ...
        private void OnEnable()
        {
            ...
            Audio.WindowsMicrophoneStreamErrorCode result = micStream.Resume();
            if (result != Audio.WindowsMicrophoneStreamErrorCode.Success)
            {
        ...
        private void OnAudioFilterRead(float[] buffer, int numChannels)
        {
            ...
            Audio.WindowsMicrophoneStreamErrorCode result = micStream.ReadAudioFrame(buffer, numChannels);
            if (result != Audio.WindowsMicrophoneStreamErrorCode.Success)
            {
